-- =====================================================
-- CORRIGIR TIPOS DE FOREIGN KEYS - VERSÃO COMPATÍVEL
-- =====================================================

-- Primeiro, vamos verificar os tipos das tabelas existentes
SELECT 
    t.table_name,
    c.column_name,
    c.data_type,
...
AND t.table_name IN ('vendedores', 'clients', 'users')
AND c.column_name = 'id'
ORDER BY t.table_name;

-- =====================================================
-- CRIAR TABELAS COM TIPOS CORRETOS
-- =====================================================
...
-- Tabela de pedidos (ajustada para UUIDs)
CREATE TABLE IF NOT EXISTS pedidos (
    id SERIAL PRIMARY KEY,
    client_id UUID REFERENCES clients(id) ON DELETE CASCADE,
    vendedor_id UUID REFERENCES vendedores(id), -- Corrigido para UUID
...
-- =====================================================
-- TABELAS SEM FOREIGN KEYS PROBLEMÁTICAS
-- =====================================================
...
-- =====================================================
-- ADICIONAR COLUNAS FALTANTES (SEM FOREIGN KEYS)
-- =====================================================
